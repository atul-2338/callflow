    ...
    <div className="flex min-h-screen flex-col px-4 pb-16">
      ...
      <div className="mx-auto w-full max-w-md">
        <div className="mb-2 flex items-center justify-between text-sm">
          <span className="font-semibold text-wire">Step {step} of 2</span>
          {step === 2 && (
            <button
              type="button"
              onClick={() => setStep(1)}
        ...
        <div className="h-1.5 w-full overflow-hidden rounded-full bg-black/[0.06]">
          <div
            className="h-full rounded-full bg-wire transition-all duration-300"
  ...
  return (
    <div className="ios-card mt-6 p-6 sm:p-8">
      ...
      <div className="mt-5 text-center text-sm">
        <Link href="/" className="font-medium text-wire hover:underline">
          Cancel and go home
        </Link>
      </div>
    </div>
